package com.mlechko.notesapp.presentation.screens.creating
...
import com.mlechko.notesapp.domain.AddNoteUseCase
...
class CreateNoteViewModel @Inject constructor(
    ...
    fun processCommand(command: CreateNoteCommand) {
        when(command){
            ...
            is CreateNoteCommand.RemoveImage -> {
                _state.update { previousState ->
                    if (previousState is CreateNoteState.Creation) {
                        previousState.content.toMutableList().apply {
...
sealed interface CreateNoteCommand {
    ...
    data class RemoveImage(val index: Int): CreateNoteCommand
